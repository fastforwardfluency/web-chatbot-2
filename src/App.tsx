    ...
    try {
      ...
      const streamResponse = await ai.models.generateContentStream({
        ...
        config: {
          ...
          - Methodology: 4 Pillars (Dopamine Hook, System 1 Shift, Hebbian Learning, Amygdala Bypass). Based on "Principles and Practice in Second Language Acquisition" and articles by Stephen Krashen.
          - Groups: Max 3 people. Exclusive men-only and women-only groups available for safety/vulnerability.
          - Frequency: 1x/week recommended (sustainable) + "Day After Protocol".
          - Tailor-Made: Co-designed formats for high-focus objectives.
          - Mindset Mentorship: Emotional/cognitive framework to unlock communication (NOT regular English classes).
          - Strategic Session (30 mins): Identify blocks, assess level, propose custom plan.
          ...
          - AI Features: Brain Reports, Day After Protocol (No mentorship videos), Quarterly Audits.
